...
$EnviarLoteRpsEnvio = $doc->getElementsByTagName("EnviarLoteRpsEnvio")->item(0);
$LoteRps = $EnviarLoteRpsEnvio->getElementsByTagName("LoteRps")->item(0);

$ListaRps = $LoteRps->getElementsByTagName("ListaRps")->item(0);

$Rps = $ListaRps->getElementsByTagName("Rps")->item(0);
$InfDeclaracaoPrestacaoServico = $Rps->getElementsByTagName("InfDeclaracaoPrestacaoServico")->item(0);
/*
...
<body style="margin-right:10px;">
			...
			<tr>
					...
					<table>
						<tr>
							...
							<td align="center" style="font-size: 12px;font-weight: bold;width:10cm">
								...
								<h3 style="margin: 0 !important;">RECIBO PROVISÓRIO DE SERVIÇOS - RPS</h3>
							</td>
						</tr>
					</table>
				</th>
				<th style='border-left: 1px solid black; vertical-align: bottom;font-size: 10px;width: 40%;'>
					<table style="margin: 0; padding: 0; border-spacing: 0;font-weight: 300;">
						...
						<tr>
							<td style='padding-top: .5rem;'>Data da Emissão <strong> <?=$row['emissao'] ?></strong></td>
						</tr>
					</table>
				</th>
			</tr>
	...
	<div class='divborda' style="padding: .5rem 0;">
		<div align='center' style='font-size: 16px; font-weight: bold;'>VALOR TOTAL DO RPS = R$ <?=number_format($VL_NF, 2, ',', '.'); ?></div>
	</div>
	<div class='divborda'>
...
$dompdf->render();
	...
	$dompdf->stream("RPS_" . $row['numerorps'] . ".pdf");
