...
$permissaoEditar = $_SESSION['SESSAO']['MODULOS'][$_GET['_modulo']]['permissao'] == 'w';
...
?>
<link rel="stylesheet" href="/form/css/conciliacaofinanceira_css.css?version=1.4" />
<div class="row">
    <div class="col-md-12">
                ...
                <div class="row col-xs-12 d-flex flex-wrap align-items-center">
                    <div class="col-xs-12 col-md-8 col-lg-9 col-xl-10">
                        <div class="row d-flex flex-wrap">
                            ...
                            <? } ?>
                            <? if (!$_1_u_conciliacaofinanceira_idconciliacaofinanceira && cb::idempresa() == 2) { ?>
                            ...
                            <div class="form-group col-xs-12 col-lg-3">
                                ...
                                <div class="w-100 d-flex flex-wrap align-items-center">
                                    <div class="col-xs-10 col-md-10 col-xl-11 pl-0 py-0">
                                        <select data-live-search="true" id="input-nfe" name="_1_<?= $_acao ?>_conciliacaofinanceira_idcontapagar" class="form-control" type="number" value="<?= $_1_u_conciliacaofinanceira_idcontapagar ?>" vnulo <?= $campoDesabilitado ?>></select>
                                    </div>
                            ...
                            <? if ($_1_u_conciliacaofinanceira_status) { ?>
                                <div class="form-group col-xs-12 col-lg-3">
                                    ...
                                    <label id="conciliacao-status" class="d-flex align-items-center form-control alert-warning">
                                        <?= $rotuloStatus ? $rotuloStatus : $_1_u_conciliacaofinanceira_status ?>
                                    </label>
                                </div>
                            <? } ?>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-4 col-lg-3 col-xl-2">
                            <div class="row d-flex align-items-center justify-content-end" style="gap: 2rem;">
                                ...
                                <? } else { ?>
                                    ...
                                    <? if (
                                        ($_1_u_conciliacaofinanceira_status != 'CONCILIADO' && $_modulo != 'conciliacaofinanceiracartoes') ||
                                        $_1_u_conciliacaofinanceira_status == 'INICIO'
                                    ) { ?>
    ...
    <? if ($_1_u_conciliacaofinanceira_idconciliacaofinanceira) { ?>
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div id="tabela-lancamentos" class="panel-body">
                    ...
                    <div id="itens-lancamento" class="w-100 <?= $_1_u_conciliacaofinanceira_status ?? '' ?> <?= (($_1_u_conciliacaofinanceira_status != 'EMCONCILIACAO' && cb::idempresa() == 2) || $_1_u_conciliacaofinanceira_status == 'CONCILIADO') ? 'desabilitado' : '' ?> <?= $permissaoVisualizar ? 'leitura' : '' ?>"></div>
        ...
        <? if (
            $permissaoEditar &&
            $_1_u_conciliacaofinanceira_status != 'CONCILIADO' &&
            (
                (
                    ($_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO' || $_1_u_conciliacaofinanceira_status == 'APROVACAOSOLICITADA') &&
                    ($_modulo == 'conciliacaofinanceiracartoes')
                ) ||
                ($_modulo != 'conciliacaofinanceiracartoes')
            )
        ) { ?>
            <div id="painel-conciliacao" class="py-1">
                <div class="row d-flex flex-between align-items-center  <?= ($_modulo != 'conciliacaofinanceiracartoes' || $_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO') ? '' : 'py-2' ?>">
                    <!-- Legenda -->
                    ...
                    <div class="col-4 d-flex flex-col align-items-center">
                        <h3 class="m-0 <?= ($_modulo != 'conciliacaofinanceiracartoes' || $_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO') ? '' : 'hidden' ?>">Itens Selecionados da fatura <strong>(<strong id="itens-selecionados-fatura" data-itensselecionadosfatura="0">0</strong>)</strong></h3>
                        <h3 class="m-0 <?= ($_modulo != 'conciliacaofinanceiracartoes' || $_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO') ? '' : 'hidden' ?>">Total <strong id="valor-total-fatura" data-valortotalfatura="0">R$ 0,0</strong></h3>
                    </div>
                    <!-- Info Sistema -->
                    <div class="col-4 d-flex flex-col align-items-center">
                        <h3 class="m-0 <?= ($_modulo != 'conciliacaofinanceiracartoes' || $_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO') ? '' : 'hidden' ?>">Itens Selecionados do sistema <strong>(<strong id="itens-selecionados-sistema" data-itensselecionadossistema="0">0</strong>)</strong></h3>
                        <h3 class="m-0 <?= ($_modulo != 'conciliacaofinanceiracartoes' || $_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO') ? '' : 'hidden' ?>">Total <strong id="valor-total-sistema" data-valortotalsistema="0">R$ 0,0</strong></h3>
                    </div>
                    <div class="flex">
                        ...
                        <? if ($_modulo != 'conciliacaofinanceiracartoes' || $_1_u_conciliacaofinanceira_status == 'EMCONCILIACAO') { ?>
...
?>
<?
require_once __DIR__ . '/js/conciliacaofinanceira_js.php';
?>