...
//die("psqfull:".$_arrModConf["psqfull"]."iget:".$iget);
	...
	$_resultados = mysql_query("select * from vwcliente_filtrarresultados where idresultado=1006194"); 
	echo 'teste';
	while ($_row = mysql_fetch_array($_resultados)){
		echo  $_row['iddashboardnucleopessoa'].'<br>';
	}
	echo mysql_num_rows($_resultados); 
	die(''); 
	if (!$_resultados) {
