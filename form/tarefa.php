			...
			<table class="table table-condensed" id="tbTarefas" style="position: relative">
				...
				<tr>
					<td colspan="99">
						...
						<? if (!empty($nlidas)){ ?>
						<div class="btn-group" role="group">
						  <button type="button" class="btn btn-default btn-xs fonte08 selecionado" id="btn-3" onclick="toggleMostrarTarefasFinalizadas(false)">Pendentes</button>
						  <button type="button" class="btn btn-default btn-xs fonte08" id="btn-4" onclick="toggleMostrarTarefasFinalizadas(true)">Todas</button>
						</div>
						<? } ?>
					</td>
				</tr>
