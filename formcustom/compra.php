...
if($pagvalmodulo == 'nfentrada'){
    if($_1_u_nf_tiponf == 'R' and $pagvalmodulo != 'comprasrh'){
        die("Dados disponíveis no modulo de RH");
    }
    if($_1_u_nf_tiponf == 'D' and $pagvalmodulo != 'comprassocios'){
        ...
        <div class="panel-heading">
            ...
            <div class="row d-flex flex-between flex-wrap">
                ...
                <div class="form-group relative col-xs-6 col-md-2">
                    ...
                    <select name="_1_<?=$_acao?>_nf_tiponf" id="tiponf" vnulo onchange="atributonnfe(this)" class="form-control">
                        <option value=""></option>
...
if($_acao == 'u'){
    ...
    $listarProdutosCadastrados = NfEntradaController::listarItensCadastrados($_1_u_nf_idnf);
                                            ...
                                            <table id="tbItens" class="table table-striped planilha">
                                                <tfoot>
                                                    ...
                                                    if($qtdTotalProdutos > 0){
                                                        ...
                                                        <? if(in_array($_1_u_nf_tiponf, ['C', 'B', 'O', 'M'])){ ?>
                                                            <tr>
                                                                <?
                                                                ...
                                                                <td title="<?=NfEntradaController::buscarTituloFrete() ?>" align="right" colspan="<?=$colspanFrete ?>" class="td-padding">
                                                                    ...
                                                                    if($modfrete == '1'){
                                                                        if(!empty($_1_u_nf_idnfe)){
                                                                            $rowcte = NfEntradaController::buscarCtePorIdNfe(substr($_1_u_nf_idnfe, 3), $_1_u_nf_idnf);
                                                                        } else {
                                                                            $rowcte = NfEntradaController::buscarCte($_1_u_nf_idnf);
                                                                        }

                                                                        $qtdcte = empty($rowcte) ? 0 : count($rowcte);
                                                                        if($qtdcte > 0){
                                                                            ?>
                                                                            <a title="CTE" class="fa fa-bars fade pointer hoverazul" href="?_modulo=nfcte&_acao=u&idnf=<?=$rowcte['idnf']?>" target="_blank"></a>
                                                                            <?
                                                                        } elseif($_1_u_nf_total > 0){
                                                                            $iconcte = ($qtdcte > 0) ? 'fa-bars azul' : 'fa-plus-circle verde';
                                                                            ?>
                                                                            <i id="btn-modal-frete" class="fa <?=$iconcte ?> fa-1x verde pointer" title="Gerar Programação de CTe"></i>
                                                                            <?
                                                                        }
                                                                    }

                                                                    if(!empty($_1_u_nf_frete) and empty($frete)){
                                                                        $frete = $_1_u_nf_frete;
                                                                    } elseif(empty($frete)){
                                                                        $frete = 0.00;
                                                                    } else {
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div>
                                                    <? if(cb::idempresa() == 4){
                                                    ?>
                                                        <input name="_1_<?=$_acao?>_nf_prazo" disabled="disabled" <? if(!empty($_1_u_nf_xmlret)){
                                                                                                                        echo "vnulo";
                                                                                                                    } ?> class="calendario size8" id="fdata1" type="text" value="<?=$_1_u_nf_prazo?>" autocomplete="off" onchange="preencherPrazo('fdata1')">
                                                        <? if($_1_u_nf_status == 'CONCLUIDO'){ ?>
                                                        ...
                                                        <input name="_1_<?=$_acao?>_nf_prazo" <? if(!empty($_1_u_nf_xmlret)){
                                                                                                    echo "vnulo";
                                                                                                } ?> class="calendario size8" <? if($_1_u_nf_status == 'CONCLUIDO'){ ?> disabled="disabled" <? } ?> id="fdata1" type="text" value="<?=$_1_u_nf_prazo?>" autocomplete="off" onchange="preencherPrazo('fdata1')">
                                                        <? if($_1_u_nf_status == 'CONCLUIDO'){ ?>
                                                            <input name="_1_<?=$_acao?>_nf_prazo" type="hidden" value="<?=$_1_u_nf_prazo?>">
                                                            <? 
                                                        }
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Data Entrada:</label>
                                    <div class="input-group col-md-12">
                                        <input name="_1_<?=$_acao?>_nf_prazo" autocomplete="off" id="fdata2" class="calendario size8" <? if($_1_u_nf_status == 'CONCLUIDO' or $qtdc100 > 0){ ?> disabled="disabled" <? } ?> id="fdata1" type="text" value="<?=$_1_u_nf_prazo?>" onchange="preencherPrazo('fdata2')">
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    <div class="col-md-5">
                                                        ...
                                                        <input class="size7 calendario dataconfdate" id="dataconf<?=$rowcx['idnfconfpagar']?>" idnfconfpagar="<?=$rowcx['idnfconfpagar']?>" name="_nfc<?=$q ?>_u_nfconfpagar_datareceb" type="text" value="<?=$rowcx['dmadatareceb']?>">
                                                        <?
                                                            ...
                                                            <div class="col-md-6 inputcheckbox">
                                                                <div class="col-md-1"> 
                                                                    <?if(!empty($rateioNf['idrateioitemdestnf']) and $rateioNf['status'] =='COBRADO' ){?>
                                                                        ...
                                                                        <? if ($acao == 'u') { ?>
                                                                            <input class="rateioitem" name="_r<?=$i?>_<?=$acao?>_rateioitemdest_idobjeto" type="hidden" value="<?=$rateioNf['idnfitem'] ?>">
...
require_once('../form/js/nfentradanovo_js.php');
