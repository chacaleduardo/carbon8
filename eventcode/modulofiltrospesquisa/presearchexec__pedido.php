...
if($_GET['_modulo']=='pedidorepresentante'){
  //  $_SESSION["SEARCH"]["WHERE"][]=" a.comissao='Y'";
}

if($_GET['_modulo']=='pedidodevolucao'){
    $_SESSION["SEARCH"]["WHERE"][]=" (a.natoptipo='devolucao' or a.natoptipo is null) ";
}else{
    $_SESSION["SEARCH"]["WHERE"][]=" (a.natoptipo !='devolucao' or a.natoptipo is null) ";
}
  
if($_GET['_modulo']=='pedidofilial'){
    $_SESSION["SEARCH"]["FROM"][0] =" vwnfsaidafilial a ";   
}
