...
$sql = "SELECT fs.idfluxostatus, s.rotulo
         ...
         WHERE f.status = 'ATIVO' AND f.modulo = '$modulo' ".$ocultar." order by fs.ordem asc";

$res=mysql_query($sql) or die("Status Solicitações de Material - Erro ao recuperar status: ".mysql_error());
$virg="";
$json = "";
