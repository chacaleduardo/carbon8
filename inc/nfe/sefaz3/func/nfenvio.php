 ...
 * par $r: Contém informacoes de cada linha da nfpxmltree para cada tag
 */
...
function GERACAO(){
	...
	<infNFe Id=\"NFe31130723259427000104550010000007531455096206\" versao=\"2.00\">
		<ide>
			<cUF>31</cUF>
			<cNF>45509620</cNF>
			<natOp>DEVOLUÇÃO MERC. USO OU CONSUMO OP. SUJ. REG. ST</natOp>
			<indPag>1</indPag>
			<mod>55</mod>
			<serie>1</serie>
			<nNF>753</nNF>
		...
		<emit>
			...
			<xNome>LAUDO LABORATÓRIO AVÍCOLA UBERLÂNDIA LTDA</xNome>
			<xFant>LAUDO LABOTATÓRIO</xFant>
			<enderEmit>
		...
		<infAdic>
			<infCpl>Nota fiscal de devolução PARCIAL referente a NFe 105.383, série 1, emitida em 12/07/2013 - item cód. prod. 30018.</infCpl>
		</infAdic>
	</infNFe>
</NFe>";
*/
...
/*
 * função nfephp que valida os campos do xml para possiveis erros de extrutura hermesp
 */
...
/*
 * Função do nfephp que envia o xml para o webservice hermesp
 */
...
if ($aResp = $nfe->autoriza($sNFe, $lote)) {
    ...
    if ($aResp['bStat']){
        ...
        //echo "Numero do Recibo : " . $aResp['nRec'] .", use este numero para obter o protocolo ou informações de erro no xml com Recibo.php.";  
