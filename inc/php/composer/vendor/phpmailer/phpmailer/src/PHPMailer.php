...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            ...
            'invalid_address1' => 'Invalid address1: ',
			'invalid_address2' => 'Invalid address2: ',
			'invalid_address3' => 'Invalid address3: ',
			'invalid_address4' => 'Invalid address4: ',
