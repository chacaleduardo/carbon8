    ...
    private $iLED_X = 4, $iLED_Y=7,
        ...
        */
        ...
        $iLEDSpec = array(
            ...
            '|' => array(4,4,4,4,4,4,4), //vertical line, used for simulate rus 'Ð«'
            ...
            ' ' => array(0,0,0,0,0,0,0),
            'â¢' => array(0,0,6,6,0,0,0), //149
            'Â°' => array(14,10,14,0,0,0,0), //176
            'â ' => array(4,4,14,4,4,4,4), //134
            'â¡' => array(4,4,14,4,14,4,4), //135
            'Â±' => array(0,4,14,4,0,14,0), //177
            'â°' => array(0,4,2,15,2,4,0), //137 show right arrow
            'â¢' => array(0,2,4,15,4,2,0), //156 show left arrow
            'Ð' => array(0,0,8,8,0,0,0), //159 show small hi-stick - that need for simulate rus 'Ð¤'
            "\t" => array(8,8,8,0,0,0,0), //show hi-stick - that need for simulate rus 'Ð£'
            "\r" => array(8,8,8,8,8,8,8), //vertical line - that need for simulate 'M', 'W' and rus 'Ð','Ð¨' ,'Ð©'
            "\n" => array(15,15,15,15,15,15,15), //fill up - that need for simulate rus 'Ð'
            "Ò" => array(10,5,10,5,10,5,10), //chess
            "Âµ" => array(15,0,15,0,15,0,15), //4 horizontal lines
            // latin
            ...
            // russian utf-8
            'Ð' => array(6,9,9,15,9,9,9),
            'Ð' => array(14,8,8,14,9,9,14),
            'Ð' => array(14,9,9,14,9,9,14),
            'Ð' => array(15,8,8,8,8,8,8),
            'Ð' => array(14,9,9,9,9,9,14),
            'Ð' => array(15,8,8,14,8,8,15),
            'Ð' => array(6,15,8,14,8,8,15),
            //Ð is combine: >\n<
            'Ð' => array(6,9,1,2,1,9,6),
            'Ð' => array(9,9,9,11,13,9,9),
            'Ð' => array(13,9,9,11,13,9,9),
            'Ð' => array(9,10,12,10,9,9,9),
            'Ð' => array(7,9,9,9,9,9,9),
            'Ð' => array(8,13,10,8,8,8,8),// need to add \r
            'Ð' => array(9,9,9,15,9,9,9),
            'Ð' => array(6,9,9,9,9,9,6),
            'Ð' => array(15,9,9,9,9,9,9),
            'Ð ' => array(14,9,9,14,8,8,8),
            'Ð¡' => array(6,9,8,8,8,9,6),
            'Ð¢' => array(14,4,4,4,4,4,4),
            'Ð£' => array(9,9,9,7,1,9,6),
            'Ð¤' => array(2,7,10,10,7,2,2),// need to add Ð
            'Ð¥' => array(9,9,6,6,6,9,9),
            'Ð¦' => array(10,10,10,10,10,15,1),
            'Ð§' => array(9,9,9,7,1,1,1),
            'Ð¨' => array(10,10,10,10,10,10,15),// \r
            'Ð©' => array(10,10,10,10,10,15,0),// need to add \r
            'Ðª' => array(12,4,4,6,5,5,6),
            'Ð«' => array(8,8,8,14,9,9,14),// need to add |
            'Ð¬' => array(8,8,8,14,9,9,14),
            'Ð­' => array(6,9,1,7,1,9,6),
            'Ð®' => array(2,2,2,3,2,2,2),// need to add O
            'Ð¯' => array(7,9,9,7,3,5,9)
            ),
