...
<tr>
    <td width=41></td>
    <td class=ti width=455><strong><?php echo $dadosboleto["identificacao"]; ?></strong> <?php echo isset($dadosboleto["cpf_cnpj"]) ? "<br>".$dadosboleto["cpf_cnpj"] : '' ?><br>
...
</tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=659 height=1><img height=1 src=imagens/2.png width=659 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct  width=7 height=12></td><td class=ct  width=530 >Demonstrativo</td><td class=ct  width=7 height=12></td><td class=ct  width=100 >Autenticação mecânica</td></tr><tr><td  width=7 ></td><td class=cp width=530 >
<span class="campo">
  ...
  </td><td  width=7 ></td><td  width=100 ></td></tr></tbody></table><table cellspacing=0 cellpadding=0 width=666 border=0><tbody><tr><td width=7></td><td  width=500 class=cp> 
<br><br><br> 
