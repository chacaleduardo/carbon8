...
SELECT
		...
		'col-md-6 col-sm-6 col-xs-6' as card_class_col,  
		concat('_modulo=cotacao&_pagina=0&_ordcol=dmaemissao&_orddir=desc&_filtrosrapidos={%22cotacao%22:%22ENVIADO%22}&idcotacao=[',group_concat(idcotacao separator ','),']') as card_url,
		'fundovermelho' as card_notification_bg,
		'0' as card_notification,
		if (count(1) > 0,'danger','success') as card_color,
		if (count(1) > 0,'danger','success') as card_border_color,
...
SELECT
		...
		'col-md-6 col-sm-6 col-xs-6' as card_class_col,  
		concat('_modulo=cotacao&_pagina=0&_ordcol=dmaemissao&_orddir=desc&_filtrosrapidos={%22cotacao%22:%22RESPONDIDO%22}&idcotacao=[',group_concat(idcotacao separator ','),']') as card_url,
		'fundovermelho' as card_notification_bg,
		'0' as card_notification,
		if (count(1) > 0,'danger','success') as card_color,
		if (count(1) > 0,'danger','success') as card_border_color,
