...
$_sqlresultado =$strselectfields." from vwrep_367 where 1 ";
...
<?
	...
	$resit = d::b()->query($sqlit);
	$qtdrowtotal = mysqli_num_rows($resit);
	$qtdrowtotal;
...
?>
	...
	<td  style="text-align: center;" class="totalentradas"><?=number_format($totalEntradas)?></td>	
    </tr>
    <tr class="res">
...
?>      	
		<td style="text-align:center;"><?= $wdes['saldo']?></td>		
<?
    }// FIM DO LOOP DE SALDO
?>  
	<td  style="text-align: center;" class="totalsaldo"><?=$totalSaldo?></td>	
    </tr>
    <tr class="res">
...
?>  
	<td colspan="<?=$qtdrowtotal?>"></td>
	<td style="color:red; text-align:center;" class="totalatraso"><?=number_format(tratanumero($totalAtrasos), 2, ',', '.') ?></td>3
