			...
			<table style="<?= $pb ?>;width:700px !important; margin:auto;  ">
				...
				<tr>
					<td>
						<div class="" style="width:700px; position:relative; z-index:111111; margin:auto; left:0; right:0; margin: 0 auto; text-align: right; padding-bottom:10px;">
							<div style="width: 700px;position:absolute; top:-3px; border-bottom:none;border-top: 1px solid gray; border-top-style: dotted;margin: auto; text-transform:uppercase; ">
								<div>Imp.: <?= $codepress ?>; <?= $versionamento ?> Início pg. p/ [<?= $row["sigla"] ?>] reg.: [<?= $row["idregistro"] ?>];&nbsp;<?if(!empty($row['idregistrodoc']) && !empty($row['versaodoc'])){?>POP ID: <?=$row['idregistrodoc']?> - VER. <?=$row['versaodoc']?><?}?></div>
																	...
																	?>
																		<tr>
																			...
																			<td class="tdval grval"> <?= ($rowend["logradouro"]) ?> <?= ($rowend["endereco"]) ?>
																				<? if ($rowend['numero']) {
																					echo ("N&ordm;:".$rowend['numero']);
																				} ?>
																				<? if ($rowend['complemento']) {
																					echo (", ".($rowend["complemento"]));
																				} ?>
																				<? if ($rowend['bairro']) {
																					echo (", BAIRRO: ".($rowend['bairro']));
																				} ?>
																				<? if ($rowend['cep']) {
																					echo (", CEP:".formatarCEP($rowend['cep'], true));
																				} ?>
																				<? if ($rowend['cidade']) {
																					echo (", ".($rowend['cidade']));
																				} ?>
																...
																<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;  ">
																	<tr style="background-color:#f7f7f7; font-size:13x; text-transform:uppercase;	height:20px;">
																		<td colspan="2" style="font-size:11px;">
																			<spam style="line-height:16px;">DADOS DA AMOSTRA</spam><span style="font-size:6px !important; width: 64%; text-align: right;">&nbsp; (As informa&ccedil;&otilde;es abaixo foram fornecidas pelo cliente) </span>
																		</td>
																	</tr>
																	<tr>
																		...
																		<td class="tdval grval">
																			<b>
																				...
																				?>
																					<a style="text-decoration:none" title="Resultado" href="javascript:janelamodal('../?_modulo=<?= $rowm['idobjeto'] ?>&_acao=u&idresultado=<?= $row["idresultado"] ?>')">
																						<font style="color:#333 !important; font-weight:bold;"><? if ($row["idunidade"] == 4) { ?>B<? } ?><?= $row["idregistro"] ?></font>
																					</a>
																				<? } else { ?>
																					<?= $row["idregistro"] ?>
																				<? } ?>
																	...
																	<? if (empty($arrAmostraCampos)) { ?>
																		<? if ($row["dataamostraformatada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Registro:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="dataamostra" campodata><?= $row["dataamostraformatada"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["datachegada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Chegada Material:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="datachegada" campodata><?= $row["datachegada"] ?></td>
																			</tr>
																		<? } ?>
																		<tr>
																			<td class="tdrot grrot">Nº Amostra(s):</td>
																			<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nroamostra"><?= ($row["nroamostra"]) ?></td>
																		</tr>
																		<? if ($row["rejeitada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Nº Amostra(s)<br>Descartadas:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="rejeitada"><?= ($row["rejeitada"]) ?></td>
																			</tr>
																		<? } ?>
																		...
																		<? if ($row["estexterno"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Registro externo:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="estexterno"><?= ($row["estexterno"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["descricao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Descri&ccedil;&atilde;o:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="descricao"><?= ($row["descricao"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["meiotransp"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Meio Transporte:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="meiotransp"><?= $row["meiotransp"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["datacoleta"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Coleta:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="datacoleta"><?= $row["datacoleta"] ?></td>
																			</tr>
																		...
																		<? if ($row["formaarmazen"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Armazenamento:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="formaarmazen"><?= ($row["formaarmazen"]) ?></td>
																			</tr>
																		<? } ?>
																		...
																		<? if ($row["lacre"]) { ?>
																			<tr>
																				...
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="lacre"><?= ($row["lacre"]) ?></td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Lacre:</td>
																		...
																		<? if ($row["galpao"]) { ?>
																			<tr>
																				...
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="galpao"><?= ($row["galpao"]) ?></td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Galp&atilde;o/Avi&aacute;rio:</td>
																		...
																		<? if ($row["linha"]) { ?>
																			<tr>
																				...
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="linha"><?= ($row["linha"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["numgalpoes"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Galpões:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="numgalpoes"><?= ($row["numgalpoes"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["localcoleta"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Local Coleta:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="localcoleta"><?= ($row["localcoleta"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["tc"]) { ?>
																			<tr>
																				<td class="tdrot grrot">TC:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tc"><?= ($row["tc"]) ?></td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																				<td class="tdrot grrot">TC:</td>
																		...
																		<? if ($row["tipo"]) { ?>
																			<tr>
																				...
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tipo"><?= ($row["tipo"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["datafabricacao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Fabrica&ccedil;&atilde;o:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="datafabricacao" campodata><?= $row["datafabricacao"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["responsavel"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Respons&aacute;vel:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="responsavel"><?= ($row["responsavel"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["responsavelof"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Resp. Oficial:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="responsavelof"><?= ($row["responsavelof"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["sexo"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Sexo:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sexo"><?= ($row["sexo"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["nrodoses"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Doses:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nrodoses"><?= ($row["nrodoses"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["partida"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Partida:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="partida"><?= ($row["partida"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["especificacao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Especifica&ccedil;&otilde;es:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="especificacao"><?= ($row["especificacao"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["fornecedor"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Fornecedor:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="fornecedor"><?= ($row["fornecedor"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["notafiscal"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Nota Fiscal:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="notafiscal"><?= $row["notafiscal"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["vencimento"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Vencimento:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="vencimento"><?= $row["vencimento"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["semana"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Semana:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="semana"><?= ($row["semana"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["identificacaochip"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Identifica&ccedil;&atilde;o/Chip:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="identificacaochip"><?= ($row["identificacaochip"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["diluicoes"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Dilui&ccedil;&otilde;es:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="diluicoes"><?= ($row["diluicoes"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["nroplacas"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Placas:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nroplacas"><?= ($row["nroplacas"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["fabricante"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Fabricante:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="fabricante"><?= ($row["fabricante"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["sexadores"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Sexadores:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sexadores"><?= ($row["sexadores"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["localexp"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Local Espec&iacute;fico:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="localexp"><?= ($row["localexp"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["pedido"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Clifor/Pedido:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="pedido"><?= ($row["pedido"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["nsvo"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; SVO:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nsvo"><?= ($row["nsvo"]) ?></td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; SVO:</td>
																		...
																		<? if ($row["cpfcnpjprod"]) { ?>
																			<tr>
																				...
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="cpfcnpjprod"><?= formatarCPF_CNPJ($row["cpfcnpjprod"], true); ?></td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																				<td class="tdrot grrot">CPF/CNPJ:</td>
																		...
																		<? if ($row["cidade"]) { ?>
																			<tr>
																				...
																				<td class="tdval grval">
																					<span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="cidade"><?= ($row["cidade"]) ?></span>
																					-
																					<span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="uf"><?= $row["uf"] ?></span>
																				</td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																		...
																		<? if (!empty($rowbio["volume"]) and !empty($row['idservicoensaio'])) { ?>
																			<tr>
																				...
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="volume"><?= ($rowbio["volume"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if (!empty($rowbio["doses"]) and !empty($row['idservicoensaio'])) { ?>
																			<tr>
																				<td class="tdrot grrot">Nº Doses:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="doses"><?= ($rowbio["doses"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if (!empty($rowbio["via"]) and !empty($row['idservicoensaio'])) { ?>
																			<tr>
																				<td class="tdrot grrot">Via de Inoculação:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="via"><?= ($rowbio["via"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if (!empty($rowbio["coranilha"]) and !empty($row['idservicoensaio'])) { ?>
																			<tr>
																				<td class="tdrot grrot">Cor da Anilha:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="coranilha"><?= ($rowbio["coranilha"]) ?></td>
																			</tr>
																		<? } ?>
																	<? } else { ?>
																		<? ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
																		...
																		<? } ?>
																		<? if ($campo["datachegada"]["visualizaemissao"] == 'Y' && $row["datachegada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Chegada Material:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="datachegada" campodata><?= $row["datachegada"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["nroamostra"]["visualizaemissao"] == 'Y' && $row["nroamostra"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Nº Amostra(s):</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nroamostra"><?= ($row["nroamostra"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["rejeitada"]["visualizaemissao"] == 'Y' && $row["rejeitada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Nº Amostra(s)<br>Descartadas:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="rejeitada"><?= ($row["rejeitada"]) ?></td>
																			</tr>
																		...
																		<? } ?>
																		<? if ($campo["estexterno"]["visualizaemissao"] == 'Y' && $row["estexterno"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Registro externo:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="estexterno"><?= ($row["estexterno"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["descricao"]["visualizaemissao"] == 'Y' && $row["descricao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Descri&ccedil;&atilde;o:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="descricao"><?= ($row["descricao"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["meiotransp"]["visualizaemissao"] == 'Y' && $row["meiotransp"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Meio Transporte:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="meiotransp"><?= $row["meiotransp"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["datacoleta"]["visualizaemissao"] == 'Y' && $row["datacoleta"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Coleta:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="datacoleta" campodata><?= $row["datacoleta"] ?></td>
																			</tr>
																		<? } elseif ($row["normativa"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Coleta:</td>
																		...
																		<? if ($campo["formaarmazen"]["visualizaemissao"] == 'Y' && $row["formaarmazen"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Armazenamento:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="formaarmazen"><?= ($row["formaarmazen"]) ?></td>
																			</tr>
																		...
																		<? if ($campo["lacre"]["visualizaemissao"] == 'Y' && $row["lacre"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Lacre:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="lacre"><?= ($row["lacre"]) ?></td>
																			</tr>
																		...
																		<? } ?>
																		<? if ($campo["linha"]["visualizaemissao"] == 'Y' && $row["linha"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Linha:</td>
																				<td class="tdval grval"   tabela="amostra" idpk="<?=$row['idamostra']?>" campo="linha"><?= ($row["linha"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["numgalpoes"]["visualizaemissao"] == 'Y' && $row["numgalpoes"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Galpões:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="numgalpoes"><?= ($row["numgalpoes"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["tc"]["visualizaemissao"] == 'Y' && $row["tc"]) { ?>
																			<tr>
																				<td class="tdrot grrot">TC:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tc"><?= ($row["tc"]) ?></td>
																			</tr>
																		...
																		<? } ?>
																		<? if ($campo["tipo"]["visualizaemissao"] == 'Y' && $row["tipo"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Tipo:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tipo"><?= ($row["tipo"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["datafabricacao"]["visualizaemissao"] == 'Y' && $row["datafabricacao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Fabrica&ccedil;&atilde;o:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="datafabricacao" ><?= $row["datafabricacao"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["responsavel"]["visualizaemissao"] == 'Y' && $row["responsavel"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Respons&aacute;vel:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="responsavel" ><?= ($row["responsavel"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["responsavelof"]["visualizaemissao"] == 'Y' && $row["responsavelof"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Resp. Oficial:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="responsavelof"><?= ($row["responsavelof"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["sexo"]["visualizaemissao"] == 'Y' && $row["sexo"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Sexo:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sexo"><?= ($row["sexo"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["nrodoses"]["visualizaemissao"] == 'Y' && $row["nrodoses"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Doses:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nrodoses"><?= ($row["nrodoses"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["partida"]["visualizaemissao"] == 'Y' && $row["partida"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Partida:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="partida"><?= ($row["partida"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["especificacao"]["visualizaemissao"] == 'Y' && $row["especificacao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Especifica&ccedil;&otilde;es:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="especificacao"><?= ($row["especificacao"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["fornecedor"]["visualizaemissao"] == 'Y' && $row["fornecedor"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Fornecedor:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="fornecedor"><?= ($row["fornecedor"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["notafiscal"]["visualizaemissao"] == 'Y' && $row["notafiscal"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Nota Fiscal:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="notafiscal"><?= $row["notafiscal"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["vencimento"]["visualizaemissao"] == 'Y' && $row["vencimento"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Vencimento:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="vencimento"><?= $row["vencimento"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["semana"]["visualizaemissao"] == 'Y' && $row["semana"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Semana:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="semana"><?= ($row["semana"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["identificacaochip"]["visualizaemissao"] == 'Y' && $row["identificacaochip"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Identifica&ccedil;&atilde;o/Chip:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="identificacaochip"><?= ($row["identificacaochip"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["diluicoes"]["visualizaemissao"] == 'Y' && $row["diluicoes"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Dilui&ccedil;&otilde;es:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="diluicoes"><?= ($row["diluicoes"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["nroplacas"]["visualizaemissao"] == 'Y' && $row["nroplacas"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Placas:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nroplacas"><?= ($row["nroplacas"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["fabricante"]["visualizaemissao"] == 'Y' && $row["fabricante"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Fabricante:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="fabricante"><?= ($row["fabricante"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["sexadores"]["visualizaemissao"] == 'Y' && $row["sexadores"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Sexadores:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sexadores"><?= ($row["sexadores"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["localexp"]["visualizaemissao"] == 'Y' && $row["localexp"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Local Espec&iacute;fico:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="localexp"><?= ($row["localexp"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["pedido"]["visualizaemissao"] == 'Y' && $row["pedido"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Clifor/Pedido:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="pedido"><?= ($row["pedido"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["nsvo"]["visualizaemissao"] == 'Y' && $row["nsvo"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; SVO:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nsvo"><?= ($row["nsvo"]) ?></td>
																			</tr>
																		...
																		<? } ?>
																		<? if ($campo["cpfcnpjprod"]["visualizaemissao"] == 'Y' && $row["cpfcnpjprod"]) { ?>
																			<tr>
																				<td class="tdrot grrot">CPF/CNPJ:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="cpfcnpjprod"><?= formatarCPF_CNPJ($row["cpfcnpjprod"], true); ?></td>
																			</tr>
																		...
																		<? } ?>
																		<? if ($campo["clienteterceiro"]["visualizaemissao"] == "Y" && $row["clienteterceiro"]) { ?><tr>
																				<td class="tdrot grrot">Cliente Terceiro:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="clienteterceiro"><?= ($row["clienteterceiro"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["regoficial"]["visualizaemissao"] == "Y" && $row["regoficial"]) { ?><tr>
																				<td class="tdrot grrot">N&ordm; Reg. Oficial:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="regoficial"><?= ($row["regoficial"]) ?></td>
																			</tr>
																			<? if ($row["idsecretaria"]) { ?><tr>
																					<td class="tdrot grrot">Org&atilde;o Oficial:</td>
																					<td class="tdval grval"><?= (traduzid("pessoa", "idpessoa", "nome", $row["idsecretaria"])) ?></td>
																				</tr><? }
																				} ?>
																		<? if ($campo["numeroanimais"]["visualizaemissao"] == 'Y' && $row["numeroanimais"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; de Animais:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="numeroanimais"><?= ($row["numeroanimais"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["sinaisclinicosinicio"]["visualizaemissao"] == 'Y' && $row["sinaisclinicosinicio"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Início Sinais Clínicos:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sinaisclinicosinicio" campodata><?= dma($row["sinaisclinicosinicio"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["sinaisclinicos"]["visualizaemissao"] == 'Y' && $row["sinaisclinicos"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Sinais Clínicos:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sinaisclinicos"><?= dma($row["sinaisclinicos"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["achadosnecropsia"]["visualizaemissao"] == 'Y' && $row["achadosnecropsia"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Achados de Necrópsia:</td>
																				<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="achadosnecropsia"><?= ($row["achadosnecropsia"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["suspclinicas"]["visualizaemissao"] == 'Y' && $row["suspclinicas"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Suspeitas Clínicas:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="suspclinicas"><?= ($row["suspclinicas"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["histproblema"]["visualizaemissao"] == 'Y' && $row["histproblema"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Histórico de Problema:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="histproblema"><?= ($row["histproblema"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["morbidade"]["visualizaemissao"] == 'Y' && $row["morbidade"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Morbidade:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="morbidade"><?= ($row["morbidade"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["usomedicamentos"]["visualizaemissao"] == 'Y' && $row["usomedicamentos"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Uso de Medicamentos:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="usomedicamentos"><?= ($row["usomedicamentos"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["usovacinas"]["visualizaemissao"] == 'Y' && $row["usovacinas"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Uso de Vacinas:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="usovacinas"><?= ($row["usovacinas"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["condconservacao"]["visualizaemissao"] == 'Y' && $row["condconservacao"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Condições de Conservação:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="condconservacao"><?= ($row["condconservacao"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["observacaointerna"]["visualizaemissao"] == 'Y' && $row["observacaointerna"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Observação Interna:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="observacaointerna"><?= ($row["observacaointerna"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["letalidade"]["visualizaemissao"] == 'Y' && $row["letalidade"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Letalidade</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="letalidade"><?= ($row["letalidade"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["responsavelcolcrmv"]["visualizaemissao"] == 'Y' && $row["responsavelcolcrmv"]) { ?>
																			<tr>
																				<td class="tdrot grrot">CRMV Responsável:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="responsavelcolcrmv"><?= ($row["responsavelcolcrmv"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["responsavelofcrmv"]["visualizaemissao"] == 'Y' && $row["responsavelofcrmv"]) { ?>
																			<tr>
																				<td class="tdrot grrot">CRMV Resposável Oficial:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="responsavelofcrmv"><?= ($row["responsavelofcrmv"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["mortalidade"]["visualizaemissao"] == 'Y' && $row["mortalidade"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Mortalidade:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="mortalidade"><?= ($row["mortalidade"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if (!empty($rowbio["volume"]) and !empty($row['idservicoensaio'])) { ?>
																			<tr>
																		...
																		<? }
																		if ($campo["idade"]["visualizaemissao"] == "Y" && $row["idade"]) { ?><tr>
																				<td class="tdrot grrot">Idade:</td>
																				<td class="tdval grval">
																				<span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="idade"><?= ($row["idade"]) ?></span>
																					<span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tipoidade">
																						<? if ($row["tipoidade"] != 'ª Progênie') {
																								echo '&nbsp;';
																							} ?><?= $row["tipoidade"] ?>
																					</span>
																				</td>
																			</tr><? } elseif ($row["normativa"]) { ?><tr>
																				<td class="tdrot grrot">Idade:</td>
																				<td class="tdinf">Não Informado</td>
																			</tr><? } ?>
																		<? if ($campo["paciente"]["visualizaemissao"] == "Y" && $row["paciente"]) { ?><tr>
																				<td class="tdrot grrot">Paciente:</td>
																				<td class="tdval grval"><?= ($row["paciente"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["tutor"]["visualizaemissao"] == "Y" && $row["tutor"]) { ?><tr>
																				<td class="tdrot grrot">Tutor:</td>
																				<td class="tdval grval"><?= ($row["tutor"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["alojamento"]["visualizaemissao"] == "Y" && $row["alojamento"]) { ?><tr>
																				<td class="tdrot grrot">Alojamento:</td>
																				<td class="tdval grval"><?= dma($row["alojamento"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["tipomicroorganismo"]["visualizaemissao"] == "Y" && $row["tipomicroorganismo"]) { ?><tr>
																				<td class="tdrot grrot">Tipo de Microorganismo:</td>
																				<td class="tdval grval"><?= ($row["tipomicroorganismo"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["tempofermentacao"]["visualizaemissao"] == "Y" && $row["tempofermentacao"]) { ?><tr>
																				<td class="tdrot grrot">Tempo de Fermentação:</td>
																				<td class="tdval grval"><?= ($row["tempofermentacao"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["modeloreator"]["visualizaemissao"] == "Y" && $row["modeloreator"]) { ?><tr>
																				<td class="tdrot grrot">Modelo Reator:</td>
																				<td class="tdval grval"><?= ($row["modeloreator"]) ?></td>
																			</tr><? }
																			if($row['idtipoteste'] == 15347){?>
																				<td class="tdrot grrot">Tipo Agente:</td>
																				<td class="tdval grval">
																					<span class="resdesc" tabela="resultado" idpk="<?=$row['idamostra']?>" campo="tipoagente"><?= $row['tipoagente'] ?></span>
																				</td>
																			</tr>
																			<?}
																		}?>
															...
															?>
																<td class="td" style="width:50%; vertical-align:top;background-color:#fff" align="right">
																	<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;">
																		...
																		?>
																			<tr>
																				<td class="tdrot grrot">Registro Biot&eacute;rio:</td>
																		...
																		<? if (empty($arrAmostraCampos)) { ?>
																			<? if ($row["granja"]) { ?><tr>
																					<td class="tdrot grrot">Granja:</td>
																					<td class="tdval grval"><?= ($row["granja"]) ?></td>
																				</tr><? } elseif ($row["normativa"]) { ?><tr>
																					<td class="tdrot grrot">Granja:</td>
																					<td class="tdinf">Não Informado</td>
																				</tr><? } ?>
																			<? if ($row["unidadeepidemiologica"]) { ?><tr>
																					<td class="tdrot grrot">Un. Epidemiológica:</td>
																					<td class="tdval grval"><?= ($row["unidadeepidemiologica"]) ?></td>
																				</tr><? } ?>
																			<? if ($row["tipoaves"]) { ?><tr>
																					<td class="tdrot grrot">Tipo Aves:</td>
																					<td class="tdval grval"><?= ($row["tipoaves"]) ?></td>
																				</tr><? } ?>
																			<? if ($row["especiefinalidade"]) {
																			?>
																				<tr>
																					<td class="tdrot grrot"><?= !empty($row['rotuloresultado']) ? $row['rotuloresultado'] : "Espécie/finalidade" ?>:</td>
																					<td class="tdval grval"><?= $row['especie'] == 'Pet' ?  $row['finalidade'] : $row["especiefinalidade"] ?></td>
																				</tr>
																			<?
																			}
																			?>
																			<? if ($row["idnucleo"]) { ?><tr>
																					<td class="tdrot grrot">N&uacute;cleo:</td>
																					<td class="tdval grval"><?= ($row["nucleoamostra"]) ?></td>
																				</tr><? } ?>
																			<? if ($row["nucleoorigem"]) { ?><tr>
																					<td class="tdrot grrot">N&uacute;cleo Origem:</td>
																					<td class="tdval grval"><?= ($row["nucleoorigem"]) ?></td>
																				</tr><? } elseif ($row["normativa"]) { ?><tr>
																					<td class="tdrot grrot">N&uacute;cleo Origem:</td>
																					<td class="tdinf">Não Informado</td>
																				</tr><? } ?>
																			<? if ($row["clienteterceiro"]) { ?><tr>
																					<td class="tdrot grrot">Cliente Terceiro:</td>
																					<td class="tdval grval"><?= ($row["clienteterceiro"]) ?></td>
																				</tr><? } ?>
																			<?
																			if ($row["regoficial"]) { ?><tr>
																					<td class="tdrot grrot">N&ordm; Reg. Oficial:</td>
																					<td class="tdval grval"><?= ($row["regoficial"]) ?></td>
																				</tr>
																				<? if ($row["idsecretaria"]) { ?><tr>
																						<td class="tdrot grrot">Org&atilde;o Oficial:</td>
																						<td class="tdval grval"><?= (traduzid("pessoa", "idpessoa", "nome", $row["idsecretaria"])) ?></td>
																			...
																			<? if ($row["lote"]) { ?><tr>
																					...
																					<td class="tdval grval"><?= ($row["lote"]) ?></td>
																				</tr><? } ?>
																			<? if ($row["idade"]) { ?><tr>
																					<td class="tdrot grrot">Idade:</td>
																					<td class="tdval grval"><?= ($row["idade"]) ?><? if ($row["tipoidade"] != 'ª Progênie') {
																																	echo '&nbsp;';
																																} ?><?= $row["tipoidade"] ?></td>
																				</tr><? } elseif ($row["normativa"]) { ?><tr>
																					<td class="tdrot grrot">Idade:</td>
																		...
																		<? } else { ?>
																			<? /////////////////////////////////////////////////////////////////////////////////
																			?>
																			<? if ($campo["granja"]["visualizaemissao"] == "Y" && $row["granja"]) { ?><tr>
																					<td class="tdrot grrot">Granja:</td>
																					<td class="tdval grval"  tabela="amostra" idpk="<?=$row['idamostra']?>" campo="granja"><?= ($row["granja"]) ?></td>
																				</tr><? } elseif ($row["normativa"]) { ?><tr>
																					<td class="tdrot grrot">Granja:</td>
																					<td class="tdinf">Não Informado</td>
																				</tr><? } ?>
																			<? if ($campo["unidadeepidemiologica"]["visualizaemissao"] == "Y" && $row["unidadeepidemiologica"]) { ?><tr>
																					<td class="tdrot grrot">Un. Epidemiológica:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="unidadeepidemiologica"><?= ($row["unidadeepidemiologica"]) ?></td>
																				</tr><? } ?>
																			<? if ($campo["tipoaves"]["visualizaemissao"] == "Y" && $row["tipoaves"]) { ?><tr>
																					<td class="tdrot grrot">Tipo Aves:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tipoaves"><?= ($row["tipoaves"]) ?></td>
																				</tr><? } ?>
																			<? if ($campo["idespeciefinalidade"]["visualizaemissao"] == "Y" && $row["especiefinalidade"]) {
																			?>
																				<tr>
																					<td class="tdrot grrot"><?= !empty($row['rotuloresultado']) ? $row['rotuloresultado'] : "Espécie/finalidade" ?>:</td>
																					<td class="tdval grval" ><?= $row['especie'] == 'Pet' ?  $row['finalidade'] : $row["especiefinalidade"] ?></td>
																			...
																			?>
																			<? if (($campo["idnucleo"]["visualizaemissao"] == "Y" || $campo["nucleoamostra"]["visualizaemissao"] == "Y") && ($row["idnucleo"] || $row["nucleoamostra"])) { ?><tr>
																					<td class="tdrot grrot">N&uacute;cleo:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nucleoamostra"><?= ($row["nucleoamostra"]) ?></td>
																				</tr><? } ?>
																			<? if ($campo["nucleoorigem"]["visualizaemissao"] == "Y" && $row["nucleoorigem"]) { ?><tr>
																					<td class="tdrot grrot">N&uacute;cleo Origem:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="nucleoorigem"><?= ($row["nucleoorigem"]) ?></td>
																				</tr><? } elseif ($row["normativa"]) { ?><tr>
																					<td class="tdrot grrot">N&uacute;cleo Origem:</td>
																					<td class="tdinf">Não Informado</td>
																				</tr><? } ?>
																			<? if ($campo["galpao"]["visualizaemissao"] == 'Y' && $row["galpao"]) { ?>
																				<tr>
																					<td class="tdrot grrot">Galp&atilde;o/Avi&aacute;rio:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="galpao"><?= ($row["galpao"]) ?></td>
																				</tr>
																			...
																			<? } ?>
																			<? if ($campo["localcoleta"]["visualizaemissao"] == 'Y' && $row["localcoleta"]) { ?>
																				<tr>
																					<td class="tdrot grrot">Local Coleta:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="localcoleta"><?= ($row["localcoleta"]) ?></td>
																				</tr>
																			<? } ?>
																			<? if ($campo["lote"]["visualizaemissao"] == "Y" && $row["lote"]) { ?><tr>
																					<td class="tdrot grrot">Lote:</td>
																					<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="lote"><?= ($row["lote"]) ?></td>
																				</tr><? } ?>
																			<? if ($campo["cidade"]["visualizaemissao"] == 'Y' && $row["cidade"]) { ?>
																				<tr>
																					<td class="tdrot grrot">Cidade:</td>
																					<td class="tdval grval">
																						<span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="cidade"><?= ($row["cidade"]) ?></span>
																		...
																		?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; de Animais:</td>
																				<td class="tdval grval"  class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="quantidadeteste"><?= ($row["quantidadeteste"]) ?></td>
																			</tr>
																		<?
																		}
																		?>
																		<? if (!empty($rowbio['rot']) and !empty($rowbio['gaiola'])) { ?><tr>
																				<td class="tdrot grrot">Local:</td>
																				<td class="tdval grval"><?= ($rowbio['rot']) ?> - GAIOLA <?= $rowbio['gaiola'] ?></td>
																			</tr><? } ?>
																		<? if (!empty($rowbio["coranilha"]) and !empty($row['idservicoensaio'])) { ?><tr>
																				<td class="tdrot grrot">Cor da Anilha:</td>
							...
							<table style="width: 100%">
								<tr>
									<td>
										<table class="tsep" style="width:100%; margin-top:6px;">
											<tr>
												<td style="text-align:center; font-size:13px !important;">RELAT&Oacute;RIO DE ENSAIO ID <?=$row['idresultado']?> - VERSÃO <?=$row['versao']?><br><?= $row["tipoteste"] ?> <?= $rowbio['rotulo'] ?></td>
											</tr>
											<tr>
												<td>
													<table class="tsep" style="width:100%;">
													...
													<table class="tsep" style="width:100%; margin-top:0px; background-color:#fff;">
														...
														<tr>
																...
																<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;  ">
																	...
																	<? if (empty($arrAmostraCampos)) { ?>
																		<? if ($row["dataamostraformatada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Registro:</td>
																			<td class="tdval grval amostra-dataamostra"><?= $row["dataamostraformatada"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["datachegada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Data Chegada Material:</td>
																				<td class="tdval grval"><?= $row["datachegada"] ?></td>
																			</tr>
																		<? } ?>
																		<tr>
																			<td class="tdrot grrot">Nº Amostra(s):</td>
																		...
																		<? if ($row["rejeitada"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Nº Amostra(s)<br>Descartadas:</td>
																				<td class="tdval grval"><?= ($row["rejeitada"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["subtipoamostra"]) { ?>
																			<tr>
																		...
																		<? if ($row["meiotransp"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Meio Transporte:</td>
																				<td class="tdval grval"><?= $row["meiotransp"] ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["datacoleta"]) { ?>
																			<tr>
																		...
																		<? if ($row["formaarmazen"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Armazenamento:</td>
																				<td class="tdval grval"><?= ($row["formaarmazen"]) ?></td>
																			</tr>
																		<? } ?>
																		...
																		<? if ($row["numgalpoes"]) { ?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; Galpões:</td>
																				<td class="tdval grval"><?= ($row["numgalpoes"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($row["localcoleta"]) { ?>
																			<tr>
																	...
																	<? } else { ?>
																		...
																		<? if ($campo["regoficial"]["visualizaemissao"] == "Y" && $row["regoficial"]) { ?><tr>
																			...
																			<? if ($row["idsecretaria"]) { ?><tr>
																					<td class="tdrot grrot">Org&atilde;o Oficial:</td>
																					<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="secretaria"><?= (traduzid("pessoa", "idpessoa", "nome", $row["idsecretaria"])) ?></td>
																				</tr><? }
																				} ?>
																		<? if ($campo["numeroanimais"]["visualizaemissao"] == 'Y' && $row["numeroanimais"]) { ?>
																			<tr>
																		...
																		<? if ($campo["sinaisclinicosinicio"]["visualizaemissao"] == 'Y' && $row["sinaisclinicosinicio"]) { ?>
																			<tr>
																				<td class="tdrot grrot">Início Sinais Clínicos:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="sinaisclinicosinicio"><?= dma($row["sinaisclinicosinicio"]) ?></td>
																			</tr>
																		<? } ?>
																		<? if ($campo["sinaisclinicos"]["visualizaemissao"] == 'Y' && $row["sinaisclinicos"]) { ?>
																			<tr>
																		...
																		<? if ($campo["paciente"]["visualizaemissao"] == "Y" && $row["paciente"]) { ?><tr>
																				<td class="tdrot grrot">Paciente:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="paciente"><?= ($row["paciente"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["tutor"]["visualizaemissao"] == "Y" && $row["tutor"]) { ?><tr>
																				<td class="tdrot grrot">Tutor:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tutor"><?= ($row["tutor"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["alojamento"]["visualizaemissao"] == "Y" && $row["alojamento"]) { ?><tr>
																				<td class="tdrot grrot">Alojamento:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="alojamento"><?= dma($row["alojamento"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["tipomicroorganismo"]["visualizaemissao"] == "Y" && $row["tipomicroorganismo"]) { ?><tr>
																				<td class="tdrot grrot">Tipo de Microorganismo:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tipomicroorganismo"><?= ($row["tipomicroorganismo"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["tempofermentacao"]["visualizaemissao"] == "Y" && $row["tempofermentacao"]) { ?><tr>
																				<td class="tdrot grrot">Tempo de Fermentação:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="tempofermentacao"><?= ($row["tempofermentacao"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["modeloreator"]["visualizaemissao"] == "Y" && $row["modeloreator"]) { ?><tr>
																				<td class="tdrot grrot">Modelo Reator:</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="modeloreator"><?= ($row["modeloreator"]) ?></td>
																			</tr><? } ?>
																		<? if ($campo["valorobjeto"]["visualizaemissao"] == "Y" && $row["dadosamostra"]["temperaturarecebimento"]) { ?><tr>
																				<td class="tdrot grrot">Temperatura de Recebimento do Material (°C):</td>
																				<td class="tdval grval " tabela="amostra" idpk="<?=$row['idamostra']?>" campo="temperaturarecebimento"><?= $row["dadosamostra"]["temperaturarecebimento"] ?></td>
																			</tr><? } ?>
																	<? } ?>
																</table>
															</td>
															...
															if (($row["granja"])
																...
																or ($row["lote"])
																or ($row["localcoleta"])
																or ($row["clienteterceiro"])
																or ($row["unidadeepidemiologica"])
																or ($row["regoficial"])
																or ($row["nucleoorigem"])
																or ($row["paciente"])
																or ($row["tutor"])
																	...
																	<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;">
																		...
																		<? } else { ?>
																			...
																			<? if ($campo["cidade"]["visualizaemissao"] == 'Y' && $row["cidade"]) { ?>
																				<tr>
																					<td class="tdrot grrot">Cidade:</td>
																					<td class="tdval grval"><span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="cidade"><?= ($row["cidade"]) ?></span>-<span class="resdesc" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="uf"><?= $row["uf"] ?></span></td>
																				</tr>
																			<? } elseif ($row["normativa"]) { ?>
																				<tr>
																					<td class="tdrot grrot">Cidade:</td>
																		...
																		?>
																			<tr>
																				<td class="tdrot grrot">N&ordm; de Animais:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="quantidadeteste"><?= ($row["quantidadeteste"]) ?></td>
																			</tr>
																		<?
																		}
																		?>
																		<? if (!empty($rowbio['rot']) and !empty($rowbio['gaiola'])) { ?><tr>
																				<td class="tdrot grrot">Local:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="gaiola"><?= ($rowbio['rot']) ?> - GAIOLA <?= $rowbio['gaiola'] ?></td>
																			</tr><? } ?>
																		<? if (!empty($rowbio["coranilha"]) and !empty($row['idservicoensaio'])) { ?><tr>
																				<td class="tdrot grrot">Cor da Anilha:</td>
																				<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="coranilha"><?= ($rowbio["coranilha"]) ?></td>
														...
														<tr>
															<td class="td" style="width:100%">
																<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;">
																	...
																	<tr>
																		<td class="tdval grval" tabela="amostra" idpk="<?=$row['idamostra']?>" campo="observacao"><?= ($varobs) ?>
																		</td>
																	</tr>
																</table>
															</td>
																				...
																				foreach ($arrassinat as $i => $rowass) {
																					...
																					switch ($rowass["idpessoa"]) {
																						...
																						case 1098: //hermes
																							...
																							break;
																						case 108437: //claiton
																							$nomresp = "CLAITON SCHWERTZ";
																							$crmvresp = "CRMV - MG N&ordm; 24293";;
																							break;
																						default:
																							null;
																							break;
																	...
																	<table style="width:100%; text-transform:none;">
																		...
																		<tr>
																			<td colspan="2" style="text-align:center">
																				<span style="font-size:6px; text-align:center; text-transform:UPPERCASE">Os resultados deste relatório se restringem às amostras ensaiadas. Esse relatório só pode ser reproduzido em sua totalidade. <br>Data da realização do ensaio: <?= $row["dataconclusao"]; ?>
																					<br />
																				</span>
																				<?
								...
								<td>
									<table class="tsep" style="width:100%; margin-top:0px;"><!-- Cabecalho Superior -->
										<tr>
											<td style="width:100%">
												<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;">
													<tr class="cabecalho_superior" style="background-color:#f7f7f7; font-size:11x;  height:20px;">
														<td idresultado="<?= $row["idresultado"] ?>" style="font-size:11px;width:25%;text-transform:uppercase;"><b>Resultado:</b> <span style="font-size:6px !important;">(<?= $row["quantidadeteste"]; ?> teste(s) realizado(s))</span> </td>
														<td></td>
														...
														<td style="vertical-align:top;text-align:right !important; width:25%; font-size:8px; line-height: 16px; padding-top: 1px;text-transform:uppercase;" align="right">
															<?
															if ($versao > 1) {
																$verant = $versao - 1;
													...
													<tr style="background-color:#f7f7f7; font-size:11x;  height:20px;">
													<td idresultado="<?= $row["idresultado"] ?>" colspan="3" style="vertical-align:bottom; font-size:12px; line-height: 29px; padding-top: 1px;" align="left">
															<span style="font-size:9px !important;text-transform:uppercase;"><b>Data de início:</b>&nbsp; <?=$row["dataamostraformatada"]?></span>&nbsp;&nbsp;
															<span style="font-size:9px !important;text-transform:uppercase;"><b>Data de término:</b>&nbsp;<?= $row["dataconclusao"]; ?></span>
														</td>
													</tr>
													<tr>
														<td class="tdval grval" colspan="4">
															<br>
															<table style="width:100%; text-transform:none;">
																...
																<tr>
																	<td colspan="3" style="text-align:center">
																		<span style="font-size:6px; text-align:center; text-transform:UPPERCASE">Os resultados deste relatório se restringem às amostras ensaiadas. Esse relatório só pode ser reproduzido em sua totalidade. <br>
