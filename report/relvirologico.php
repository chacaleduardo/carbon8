...
if(!empty($teste)){
    $clausula .= " a.idtipoteste = ".$teste." and ";
}
...
//echo $clausula;die;
$sql = " select * from vwrelvirologico a " . $clausula . " order by idregistro";
...
//O header foi colocado em variavel para aparecer de 15 em 15 linhas
$header = "
<table  margin'0' padding='0' style='border:0px;'>
    <tr style='border:0px;'>
	    <td style='border:0px;'>
		<div class='title12'>Virológia</div>
	    </td>
    </tr>
    <tr style='border:0px;'>
	<td style='border:0px;'>
		...
		<td nowrap>Nº Reg.</td>
		<td nowrap>Data</td>
		<td nowrap>Nome Fantasia</td>
		<td nowrap>Tipo</td>
		<td nowrap>Qtd</td>
		<td nowrap>Sigla</td>
		
		<td nowrap>Lote</td>
		<td nowrap>N&uacute;cleo</td>
		<td nowrap align='center' style='width:400px;'>Resultado</td>
		<td nowrap>Pos.</td>
	      </tr>";
$rodape="</table>
	</td>
...
echo $header;
    $l=0;
		...
		?>
		 <tr class="res1">
		    <td nowrap style="border:1px solid;width:0px;"><?=$row["exercicio"]  ?></td>
		    ...
		    <td nowrap style="border:1px solid;width:0px;"><?=$row["dataamostraformatada"] ?></td>
		    <td style="border:1px solid;width:0px;"><?=$row["nome"] ?></td>
		    <td nowrap style="border:1px solid;width:0px;"><?=$row["tipoamostra"] ?></td>
		    <td nowrap style="border:1px solid;width:0px;"><?=$row["quantidade"]  ?></td>
		    <td nowrap style="border:1px solid;width:0px;"><?=$row["sigla"]  ?></td>
		    <td style="border:1px solid;width:0px;"><?=$row["lote"] ?></td>
		    <td style="border:1px solid;width:0px;"><?=$row["nucleoamostra"] ?></td>
		    <td style="border:1px solid;width:0px;"></td>
		    <td style="border:1px solid; width: 30px; height: 70px;"></td>
		  </tr>
