...
?>
	...
	$strtabini = "\n<table class='normal' id='content' style='margin-left: 10px;'>";
	...
	//echo("<br>[$_strhlcolor]<br>");
    	echo "\n<tr style='height:32px;' class=\"res\" ". $_link ." ". $_strhlcolor . ">";
	...
	if($_numlinha == "Y"){
		...
		$_strvlrhtml="";
    	    ...
    	    if($arrRep["_filtros"][$_nomecol]["visres"] == 'Y'){
				...
				if(!empty($arrRep["_filtros"][$_nomecol]["hyperlink"])){
					echo "<td style='min-width: 35px;'>".$_hyperlink."</td>";
				}else{
					 echo "<td style='min-width: 90px;' ".$_stralign." ".$_hyperlink." ".$_colorlink.">".$_corfont.$_strvlrhtml.$_corfontfim."</td>";
				}
