...
$urlLogo = "../inc/img/cabecalho-relatorio-de-ensaio-LAUDO-INATA.jpg";

if($_GET['_idempresa'] == 1) $urlLogo = "../inc/img/cabecalho-relatorio-de-ensaio-720.png";
if($_GET['_idempresa'] == 2) $urlLogo = "../inc/img/cabecalho-relatorio-de-ensaio-INATA.png";
				...
				<td>
					<div>
						<table class="cabtxt" style="width:100%;position:relative; z-index:2; background-color:#fff; margin-bottom:0px;">
							<tr>
								<td >
									<img style="width:573px; height:90px; border-radius: 7px 0px 0px 0px; border-right:none;" src="<?= $urlLogo ?>">&nbsp;
								</td>
													...
													<td>
														<table class="tbgr" style="width:100%; border:1px solid #f7f7f7;">
															...
															<tr>
																...
																<td class="tdval grval"><?= $dadosAmostra["granja"] ?></td>
																<td colspan="2" class="tdrot grrot"></td>
															</tr>
