...
if (!empty($_GET)){
	...
	require_once(__DIR__."/scripts/_8repprint_335_324_montarclausulaidempresa.php");
	 ...
	 ****************************************************************************/
	$relatorios = MenuRelatorioController::buscarRelatorioDinamico($strselectfields, ($_sqlresultado.$_sqldata.$str_fts.$strgrp.$strord));
	if ($relatorios === false) {
