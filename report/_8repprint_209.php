...
<?
    ...
    while ($_row = mysql_fetch_array($_resultados)){
		...
		if($especie!=$_row[0]){
			$mostrar = '<tr style="background-color:#eee; font-size:10px"><td colspan="7" ><b>TOTAL '.$especie.'</td><td align="right"><b>'.number_format($vtotal, 2, ',','.').'</b></td></tr>';
			$vtotal=0;
