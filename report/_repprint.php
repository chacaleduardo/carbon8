...
if ($_idrep == 94 || $_idrep == 22 ){
	...
	if (base64_decode('MTA2ODQz') == $_SESSION["SESSAO"]["IDPESSOA"] || base64_decode('MTk0NA==') == $_SESSION["SESSAO"]["IDPESSOA"] || base64_decode('ODE4Nw==') == $_SESSION["SESSAO"]["IDPESSOA"]){
...
if (!empty($_GET)){
	...
	$_and_idempresa=" and  idempresa =".$_SESSION["SESSAO"]["IDEMPRESA"]." ";
